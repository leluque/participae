...
@Service
public class ServicoAtualizacaoSEMAEImpl extends ServicoAtualizacaoMogi implements ServicoAtualizacaoSEMAE {
	...
	private static final String URL_GERAL = "http://www.licitacao.pmmc.com.br/transparencia_semae/vencimentos2?csv=true";
	private static final String URL_DETALHES = "http://www.licitacao.pmmc.com.br/transparencia_semae/detalhamento?rgf=";

	public ServicoAtualizacaoSEMAEImpl(ServicoCidade servicoCidade, ServicoServidor servicoServidor,
	...
	public long atualizarRemuneracao() throws ErroCarregamentoDadosExistentes, ErroCarregandoNovosDados {
		...
		try {
			...
			for (EntradaServidorCSV entradaServidor : entradasServidores) {
				...
				servidor.setTipoAdicional("SEMAE");
